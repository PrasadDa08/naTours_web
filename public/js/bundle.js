        ...
        function n() {
          ...
          function d(e, r, s, t) {
            var o = r && r.prototype instanceof q ? r : q,
              ...
              u = new T(t || []);
            return i(n, '_invoke', { value: O(e, s, u) }), n;
          }
          function m(e, r, s) {
            try {
            ...
            return function (n, i) {
              ...
              for (t.method = n, t.arg = i; ; ) {
                ...
                if ('next' === t.method) t.sent = t._sent = t.arg;
                  ...
                  if (o === f) throw ((o = y), t.arg);
                  t.dispatchException(t.arg);
                } else 'return' === t.method && t.abrupt('return', t.arg);
                o = h;
                var a = m(r, s, t);
                if ('normal' === a.type) {
                  if (((o = t.done ? y : p), a.arg === g)) continue;
                  return { value: a.arg, done: t.done };
                }
                'throw' === a.type &&
                  ((o = y), (t.method = 'throw'), (t.arg = a.arg));
              }
            };
          }
          function S(r, s) {
            ...
            var n = m(o, r.iterator, s.arg);
            if ('throw' === n.type)
              return (
                (s.method = 'throw'), (s.arg = n.arg), (s.delegate = null), g
              );
            var i = n.arg;
            return i
              ? i.done
                ? ((s[r.resultName] = i.value),
                  (s.next = r.nextLoc),
                  'return' !== s.method && ((s.method = 'next'), (s.arg = e)),
                  (s.delegate = null),
                  g)
                : i
              : ((s.method = 'throw'),
          ...
          return (
            ...
            k(_.prototype),
            j(_.prototype, a, function () {
              return this;
            }),
            (r.AsyncIterator = _),
            (r.async = function (e, s, t, o, n) {
              void 0 === n && (n = Promise);
              var i = new _(d(e, s, t, o), n);
              return r.isGeneratorFunction(s)
                ? i
            ...
            (T.prototype = {
              ...
              finish: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                  ...
                  if (s.finallyLoc === e)
                    return this.complete(s.completion, s.afterLoc), G(s), g;
                }
              },
              catch: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (e.next = 3),
                            (0, t.default)(
                              'https://natours-web-e50y.onrender.com/api/v1/bookings/checkout-session/'.concat(
                                n,
                              ),
                            )
                          );
    ...
    Focm: [
      function (require, module, exports) {
        ...
        function i() {
          ...
          var x = Object.getPrototypeOf,
            S = x && x(x(N([])));
          S && S !== r && n.call(S, c) && (L = S);
          var _ = (E.prototype = w.prototype = Object.create(L));
          function I(t) {
        ...
        l &&
          ...
          s && s.addEventListener('click', t.logout),
          f &&
